...
describe(`${HelperDateService.name}`, () => {
  let service: HelperDateService;

  beforeEach(async () => {
    service = new HelperDateService();
    process.env.TZ = 'UTC';
  });
  ...
  describe('calculateAge', () => {
    it('should calculate age correctly', () => {
      const dateOfBirth = new Date('2000-03-24');
      const age = service.calculateAge(dateOfBirth, 2023);
  ...
  describe('diff', () => {
    it('should diff two dates and return result in days by default', () => {
      const dateOne = new Date('2023-11-25');
      const dateTwo = new Date('2023-11-27');
  ...
  describe('checkDateTime', () => {
    ...
    it('should check date time if a given date is valid', () => {
      const validDate = '2023-11-25T01:01:01.000Z';
      expect(service.checkDateTime(validDate)).toEqual(true);
    });
  ...
  describe('create', () => {
    ...
    it('should create a date with given value and options', () => {
      ...
      expect(createdDate).toEqual(new Date(`2023-11-24T23:00:00.000Z`));
    });

    it('should create a date time with given value', () => {
      const date = '2023-11-25T01:01:01.000Z';
      const createdDate = service.create(date);

      expect(createdDate).toEqual(new Date(`2023-11-25T01:01:01.000Z`));
    });
  });
  ...
  describe('timestamp', () => {
    ...
    it('should return a timestamp with given options', () => {
      const date = '2023-11-24T23:00:00.000Z';
      const startOfDay = true;
  ...
  describe('format', () => {
    it('should format a date', () => {
      ...
      expect(formattedDate).toEqual('2023-11-25');
    });
  ...
  describe('forwardInSeconds', () => {
    it('should add seconds to a date', () => {
      ...
      expect(resultDate).toEqual(new Date('2023-11-25T00:01:00.000Z'));
    });
  });

  describe('backwardInSeconds', () => {
    it('should subtract seconds from a date', () => {
      const fromDate = new Date('2023-11-25T00:01:00.000Z');
      const seconds = 60;
  ...
  describe('forwardInMinutes', () => {
    it('should add minutes to a date', () => {
      ...
      expect(resultDate).toEqual(new Date('2023-11-25T01:00:00.000Z'));
    });
  });

  describe('backwardInMinutes', () => {
    it('should subtract minutes from a date', () => {
      const fromDate = new Date('2023-11-25T01:00:00.000Z');
      const minutes = 60;
  ...
  describe('forwardInHours', () => {
    it('should add hours to a date', () => {
      ...
      expect(resultDate).toEqual(new Date('2023-11-26T00:00:00.000Z'));
    });
  });

  describe('backwardInHours', () => {
    it('should subtract hours from a date', () => {
      const fromDate = new Date('2023-11-26T00:00:00.000Z');
      const hours = 24;
  ...
  describe('forwardInDays', () => {
    it('should add days to a date', () => {
      ...
      expect(resultDate).toEqual(new Date('2023-12-26T00:00:00.000Z'));
    });
  });

  describe('backwardInDays', () => {
    it('should subtract days from a date', () => {
      const fromDate = new Date('2023-12-26T00:00:00.000Z');
      const days = 31;
  ...
  describe('forwardInMonths', () => {
    it('should add months to a date', () => {
      ...
      expect(resultDate).toEqual(new Date('2023-12-25T00:00:00.000Z'));
    });
  });

  describe('backwardInMonths', () => {
    it('should subtract months from a date', () => {
      const fromDate = new Date('2023-12-25T00:00:00.000Z');
      const months = 1;
  ...
  describe('endOfMonth', () => {
    it('should return the end of the month for a given date if no date is provided', () => {
      const date = '2023-01-30T23:59:59.999Z';
      const endDate = service.endOfMonth(new Date(date));
      expect(endDate).toEqual(new Date('2023-01-31T22:59:59.999Z'));
    });
  });

  // describe('startOfMonth', () => {
  //   it('should return the start of the month for a given date if no date is provided', () => {
  //     const date = '2023-11-25T00:00:00.000Z';
  //     const startDate = service.startOfMonth(new Date(date));
  //     expect(startDate).toEqual(new Date('2023-11-25T00:00:00.000Z'));
  //   });
  // });
  ...
  //     expect(endDate).toEqual(new Date('2023-12-31T23:59:59.999Z'));
  //   });
  // });
  ...
  //     const date = '2023-11-25T23:59:59.999Z';
  //     const endDate = service.endOfDay(new Date(date));
  //     expect(endDate).toEqual(new Date('2023-11-25T23:59:59.999Z'));
  //   });
  // });
  ...
  //     const date = new Date('2023-11-25T12:34:56.789Z');
  //     const roundedDate = service.roundDown(date, {
  //       hour: true,
  //       minute: true,
  //       second: true,
  //     });
  //     expect(roundedDate).toEqual(new Date('2023-11-25T00:00:00.000Z'));
  //   });
  // });
  ...
  //     const startDate = new Date('2023-11-25T00:00:00.000Z');
